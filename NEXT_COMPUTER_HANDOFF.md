...
- **2026-06-08 新增**：设置页新增“重选宠物”功能，点击后跳转到宠物选择界面，选择后返回设置页。
- **2026-06-08 新增**：宠物名称从“果果”改回为“菲菲”，主界面标题同步改为“菲菲加油！”。
- **2026-06-08 新增**：课文填空题（text_fill 类型）支持内联手写框模式。题目文本中的每个填空处嵌入小手写框（56×36，统一尺寸，带田字格网格线），点击后弹窗手写，保存后缩略图显示在题目中。弹窗顶部只显示当前填空对应的题目前缀文本。目前仅 `text_fill_8_units.json` Day1 第一题启用了此模式作为试验，效果已确认，方案已定。
